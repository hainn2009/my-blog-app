...
export default class Form extends Component {
  ...
  validateField = (id) => {
    ...
    const { value: fieldValue, validate, displayName, customRules = {} } = this.state.fields[id];
    ...
    if (rules.length) {
      for (const rule in rules) {
        ...
        const isRuleSatisfied = ruleName !== "required" && !fieldValue ? true : validation.rule().test(fieldValue.toString());
